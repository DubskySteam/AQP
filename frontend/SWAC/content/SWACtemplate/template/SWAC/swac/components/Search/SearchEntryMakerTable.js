...
class SearchEntryMakerTable extends SearchEntryMaker {
    ...
    isApplicable(searchResult, resultElem) {
        ...
        if (!resultTable) {
            Msg.warn('SearchEntryMakerTable', 'This resultEntryMaker can not be applied because there is no table in the template.');
            return false;
        }
        return true;
    }
    ...
    make(searchResults, resultNo, placeElement) {
        ...
        if (!resultTable) {
            Msg.error('SearchEntryMakerTable', 'There was no table found in template part for results.');
            return;
        }
        // Create table head
