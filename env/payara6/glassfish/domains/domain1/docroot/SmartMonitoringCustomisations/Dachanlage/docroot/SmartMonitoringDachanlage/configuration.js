...
var SWAC_config = {
    ...
    debug: '',
    globalparams: {
        smartdataurlnenc: baseurl + '/SmartDataDachanlage',
        smartdataurl: encodeURIComponent(baseurl) + '%2FSmartDataDachanlage',
        measurefreq: 10
    },
    datasources: [
        {
            url: "/SmartDataDachanlage/smartdata/[iface]/[fromName]?storage=smartmonitoring",
            interfaces: {
                get: ['GET', 'records'],
                list: ['GET', 'records'],
                defs: ['GET', 'collection'],
        ...
        {
            url: "/SmartMonitoringBackendDachanlage/smartmonitoring/[fromName]",
            interfaces: {
                get: ['GET', 'get'],
                list: ['GET', 'list'],
                defs: ["GET", 'definition'],
