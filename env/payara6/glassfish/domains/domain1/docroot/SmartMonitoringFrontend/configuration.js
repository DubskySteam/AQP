...
var SWAC_config = {
    ...
    debug: '',
    globalparams: {
        smartdataurlnenc: baseurl + '/SmartDataTest',
        smartdataurl: encodeURIComponent(baseurl) + '%2FSmartDataTest',
        measurefreq: 10
    },
    startuptests: [
    ],
    datasources: [
        {
            url: "/SmartDataTest/smartdata/[iface]/[fromName]?storage=smartmonitoring",
            interfaces: {
                get: ['GET', 'records'],
                list: ['GET', 'records'],
                defs: ['GET', 'collection'],
    ...
    progressive: {
        ...
        precache: [
            ...
            '/customisations/favicon.png',
            '/customisations/loginbg.jpg',
            '/customisations/logo-fhbi.png',
            '/customisations/logo-ife.png',
            '/customisations/logo.avif',
            '/customisations/logo.png',
            '/customisations/logo.webp',
            '/customisations/projekt.avif',
            '/customisations/projekt.jpg',
            '/customisations/object/icons/.avif',
            '/customisations/object/icons/.png',
            // default data
            '/manifest.json',
            '/configuration.js'
        ],
