...
var SWAC_config = {
    ...
    debug: '',
    globalparams: {
        smartdataurlnenc: baseurl + '/SmartDataTeststand',
        smartdataurl: encodeURIComponent(baseurl) + '%2FSmartDataTeststand',
        measurefreq: 10
    },
    datasources: [
        {
            url: "/SmartDataTeststand/smartdata/[iface]/[fromName]?storage=smartmonitoring",
            interfaces: {
                get: ['GET', 'records'],
                list: ['GET', 'records'],
                defs: ['GET', 'collection'],
        ...
        {
            url: "/SmartMonitoringBackendTeststand/smartmonitoring/[fromName]",
            interfaces: {
                get: ['GET', 'get'],
                list: ['GET', 'list'],
                defs: ["GET", 'definition'],
